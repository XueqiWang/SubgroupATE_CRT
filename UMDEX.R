...
# overall test
np_overall <- calc_overall(beta_2=beta_2, beta_4=beta_4, m=m, rho_y=rho_y, rho_s=rho_s, p_1=p_1)
np_overall
n_overall <- np_overall[1] # 12
pred.power_overall <- np_overall[2]
